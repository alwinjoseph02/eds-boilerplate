...
## Environments
- Preview: https://main--eds-boilerplate--alwinjoseph02.aem.page/
- Live: https://main--eds-boilerplate--alwinjoseph02.aem.live/
...
1. Open the `eds-boilerplate` directory in your favourite IDE and start coding :)
